...
var ConnectionsList = function ConnectionsList (_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      Segment,
      null,
      React.createElement(Header, { size: 'medium' }, 'Pending'),
      React.createElement(CardGroup, {
        centered: true,
        items: pendingConnections.map(toCardGroupItem)
      })
    ),
    React.createElement(
      Segment,
      null,
      React.createElement(Header, { size: 'medium' }, 'Active'),
      React.createElement(CardGroup, {
        centered: true,
        items: activeConnections.map(toCardGroupItem)
      })
    )
  )
}
