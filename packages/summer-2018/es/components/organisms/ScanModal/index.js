...
var ScanModal = function (_Component) {
  ...
  ScanModal.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
    return nextProps.scanData !== undefined ? _extends({}, prevState, { open: true }) : null;
  };
  ...
  ScanModal.prototype.render = function render() {
    ...
    return React.createElement(
      Modal,
      { dimmer: 'blurring', open: open, onClose: function onClose() {
